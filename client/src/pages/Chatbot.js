    ...
    login: [
      {
        ...
        answer:
          "Use your registered email and password to log in on the login page.",
      },
      {
      ...
      },
      {
        ...
        answer:
          'Yes, you can enable the "Remember Me" option during login to stay logged in on the device.',
      },
      {
        question: "What do I do if my login is not working?",
        answer:
          "Make sure your credentials are correct or reset your password if necessary.",
      },
      {
        question: "How can I log out?",
        answer:
          'You can log out by clicking the "Logout" button in your account settings.',
      },
      {
        question: "Can I use social media to log in?",
        answer:
          "Yes, we offer options to log in using Facebook, Google, and other social media accounts.",
      },
      {
        question: "Why am I being redirected to the login page?",
        answer:
          "You may have been logged out due to inactivity or a session timeout.",
      },
      {
    ...
    register: [
      {
        ...
        answer:
          "To register, visit the registration page and fill in your details.",
      },
      {
        question: "What do I need to register?",
        answer:
          "You will need your name, email, phone number, and password to complete registration.",
      },
      {
        question: "Can I register without an email?",
        answer:
          "An email address is required for registration to receive confirmation and notifications.",
      },
      {
        question: "What should I do if I have issues registering?",
        answer:
          "Please check if your details are correct or contact support for assistance.",
      },
      {
        question: "Can I register using my social media account?",
        answer:
          "Yes, you can register using Facebook, Google, or other social media accounts.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "You can update your details through your profile page after logging in.",
      },
    ],
    appointment: [
      {
        ...
        answer:
          "Log in to your account, select a doctor, and book an available slot.",
      },
      {
        question: "Can I change my appointment?",
        answer:
          "Yes, you can reschedule your appointment by logging into your account.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Please reschedule as soon as possible to avoid any inconvenience.",
      },
      {
        question: "How can I choose a doctor?",
        answer:
          "Browse through the list of doctors by specialty and select the one that suits your needs.",
      },
      {
        question: "Can I book multiple appointments?",
        answer:
          "Yes, you can book multiple appointments with different doctors.",
      },
      {
        question: "What should I do if the doctor is unavailable?",
        answer:
          "You can select an alternative time slot or book with another doctor.",
      },
      {
        question: "Do I need to pay for the appointment upfront?",
        answer:
          "Payment may be required during the booking process, depending on the doctor or service.",
      },
    ],
    password: [
      {
      ...
      },
      {
        ...
        answer:
          "Password reset requires access to the email account used during registration.",
      },
      {
        question: "Can I change my password from the account settings?",
        answer:
          "Yes, you can change your password anytime from the settings page after logging in.",
      },
      {
